  ...
  return (
    <>
      ...
      <div className="absolute left-0 top-0 flex h-screen w-full place-items-center justify-center ">
        <div className="w-[90vw]  rounded-md bg-light-secondary px-4 py-8  md:w-[400px]">
          <div className="mb-10 text-3xl  font-bold">Sign In</div>
            ...
            {Object.values(providers).map((provider, key) => (
              <div key={key}>
                <button
                  ...
                  className="w-full rounded-md bg-light-primary py-2.5 font-semibold text-white transition hover:bg-light-accent/80"
                >
